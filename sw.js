const CACHE='sansuo-champion-v3-dashboard';
const ASSETS=['./','./index.html','./styles.css','./parent-dashboard.css','./app.js','./parent-dashboard.js','./problems.js','./problem_engine.js','./all_problems.js','./curriculum.js','./manifest.webmanifest','./assets/icon.svg'];
