const CACHE='sansuo-champion-v4-sapix-analyzer';
const ASSETS=['./','./index.html','./styles.css','./parent-dashboard.css','./app.js','./parent-dashboard.js','./sapix-analyzer.js','./problems.js','./problem_engine.js','./all_problems.js','./curriculum.js','./manifest.webmanifest','./assets/icon.svg'];
