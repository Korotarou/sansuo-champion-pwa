const CACHE='sansuo-champion-v2-438';
const ASSETS=['./','./index.html','./styles.css','./app.js','./problems.js','./problem_engine.js','./all_problems.js','./curriculum.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
