...
assert.throws(() => validateRootAppCache(worker.replace('v18-', 'v17-'), payload), /latest registered version/);
assert.throws(() => validateRootAppCache(worker.replace('v18-', 'v19-'), payload), /latest registered version/);
