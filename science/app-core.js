...
function defaultState(){
  return {version:APP_VERSION, answered:0, correct:0, explained:0, sessions:0, streak:0, lastStudy:null, history:{}, attemptLog:[], causes:{knowledge:0,principle:0,reading:0,strategy:0,calc:0,careless:0}, daily:{date:null,count:0}, sapixSections:[], sapixTests:[]};
}
function loadState(){
