...
function header(title,sub){return '<div class="top"><div><div class="eyebrow">SOCIAL LAB 418</div><h1>'+esc(title)+'</h1><div class="muted">'+esc(sub||"")+'</div></div><div class="top-actions"><a class="btn ghost subject-home-link" href="../" aria-label="3科ホームへ">3科ホーム</a><button class="btn ghost" onclick="App.installHelp()">iPad追加</button></div></div>';}
