const CACHE='social-lab-418-v02-20260907';
const ASSETS=['./','./index.html','./styles.css','./data.js','./problem-engine.js','./app.js','./manifest.webmanifest','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
